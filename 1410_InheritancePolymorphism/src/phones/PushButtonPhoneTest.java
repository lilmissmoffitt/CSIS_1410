...
/**
 * * Tests the public methods from class PushButtonPhone. * * = = = This test
 * class should not be modified. = = =
 */
class PushButtonPhoneTest {
	@Test
	void pushButtonPhone_initializesFields() {
		PushButtonPhone pushButtonPhone1 = new PushButtonPhone("Avaya 9611G IP", new Dimension(249.87, 199.9, 70.1),
				Voltage.V110);
	...
	void call_returnsMessageIncludingTheNumberProvided() {
		PushButtonPhone pushButtonPhone2 = new PushButtonPhone("Cortelco 2500", new Dimension(178, 228, 127),
				Voltage.DUAL);
