...
/**
 * * Tests the constructor and the public methods from * class Dimension. * * =
...
class DimensionTest {
	...
	void dimension_nonPositiveHeight_ThrowsIllegalArgumentException() {
		...
		assertEquals("The height, width, and depth of a dimension needs to be positive.", exception.getMessage());
	}
