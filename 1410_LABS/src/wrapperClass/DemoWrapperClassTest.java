...
/**
 * 
 * JUnit tests to test the static methods in class DemoWrapperClass. This test
...
class DemoWrapperClassTest {
	...
	void testGetRandomLetter() {
		...
		assertTrue(map.get('a') > 0 && map.get('z') > 0 && map.get('A') > 0 && map.get('Z') > 0);
	}
