...
class FriendTest {
	...
	void play_2FriendsInArray_ReturnsStringWith2Friends() {
		Friend[] friends = new Friend[] {
				new Friend("Billy", 75, Hobby.GAMES),new Friend("Riley", 43, Hobby.SPORTS)};
	...
	void play_4FriendsInArray_ReturnsStringWith3Friends() {
		Friend[] friends = new Friend[] {
				new Friend("Billy", 75, Hobby.GAMES),new Friend("Riley", 43, Hobby.SPORTS),new Friend("Ellie", 34, Hobby.GAMES)};
	...
	void play_4FriendsInArray_ReturnsStringWith4Friends() {
		Friend[] friends = new Friend[] {
				new Friend("Billy", 75, Hobby.GAMES),new Friend("Riley", 43, Hobby.SPORTS),new Friend("Ellie", 34, Hobby.GAMES),new Friend("Jessie", 39, Hobby.MUSIC)};
